<div>
    <div class="mb-6"><h2 class="text-2xl font-bold text-gray-800"><i class="fas fa-plus mr-2"></i>Registrar Servicio Funerario</h2></div>
        ...
        <form wire:submit="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <select wire:model.live="afiliado_id" class="w-full px-3 py-2 border rounded-lg @error('afiliado_id') border-red-500 @enderror">
