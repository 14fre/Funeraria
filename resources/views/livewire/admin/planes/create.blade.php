            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Ej: Plan Individual Premium">
                    @error('nombre')
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="descripcion"
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('descripcion') border-red-500 @enderror"
                ...
                <div>
                    ...
                    @error('max_beneficiarios')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Sugerido para {{ $tipo }}: {{ match($tipo) { 'individual' => 1, 'familiar' => 5, 'empresarial' => 50, 'anticipado' => 10, default => 1 } }}</p>
                </div>
