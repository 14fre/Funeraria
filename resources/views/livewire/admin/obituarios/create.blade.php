    ...
    <form wire:submit="save">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" wire:model="numero_documento" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Para consulta pública">
            </div>
            <div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Publicado (visible en web)</label>
